...
percent_plot <- map(seq(nrow(bookmovies_vs_allmovies)), ~bookmovies_vs_allmovies[c(seq(.x), rep(.x, nrow(bookmovies_vs_allmovies) - .x)), ]) %>% 
    ...
    geom_path(aes(color="Percent of Total Gross of Book-Based Movies of Total Movie Gross")) +
    geom_point()+
    geom_point(aes(y= percent_book_movies, color= "Percent of Book-Based Movies of All Movies Made"))+
    geom_path(aes(y= percent_book_movies))+
    scale_color_manual(name= '', values= c('Percent of Total Gross of Book-Based Movies of Total Movie Gross'= '#42f46e', 'Percent of Book-Based Movies of All Movies Made'='#4286f4'))+
    scale_y_continuous()+
    scale_x_continuous()+
    xlab("Year") +
    ylab("Percent of Total Gross or Total Movies Made")+
    theme_economist()+
    labs(title= "Book Movies vs Total movies", subtitle= "By year")
