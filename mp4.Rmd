...
output:
   html_document:
    code_folding: hide
---
Problem Statement: Our goal was to study the relationship between books and movies, and how the success of movies based on books compares to the success of movies not based on books. Specifically, we chose to focus on whether or not movies based on books gross more in opening weekends than movies that are not based on books.
